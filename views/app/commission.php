...
<section class="content-grid content-grid--2">
    <article class="panel">
        <div class="panel-head">
            <div>
                <span class="section-tag">Estado de comision</span>
    ...
    <article class="panel">
        <div class="panel-head">
            <div>
                ...
                <h3>Ultimas trazas visibles</h3>
            </div>
        </div>
        <div class="timeline-list">
            <?php foreach ($recent_activity as $item): ?>
                <div class="timeline-item" data-search-row="<?php echo h(strtolower($item['title'] . ' ' . $item['copy'])); ?>">
...
<section class="content-grid content-grid--3">
    ...
    <article class="panel panel--map" id="mapa">
        <div class="panel-head">
            <div>
                <span class="section-tag">Mapa visual</span>
                <h3>Puntos relacionados</h3>
            </div>
        </div>
        <div class="map-stage">
    ...
    <article class="stack-panel">
        ...
        <article class="panel">
            <div class="panel-head">
                <div>
                    <span class="section-tag">En foco</span>
                    <h3>Modulos destacados</h3>
                </div>
            </div>
