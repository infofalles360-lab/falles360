...
<section class="content-grid content-grid--2">
    <article class="panel">
        <div class="panel-head">
            <div>
                <span class="section-tag">Actividad reciente</span>
                <h3>Ultimos movimientos del sistema</h3>
            </div>
        </div>
        <div class="timeline-list">
            <?php foreach ($recent_activity as $item): ?>
                <div class="timeline-item" data-search-row="<?php echo h(strtolower($item['title'] . ' ' . $item['copy'] . ' ' . $item['label'])); ?>">
                    ...
                    <div class="timeline-meta">
                        <span class="badge badge--soft"><?php echo h($item['label']); ?></span>
    ...
    <article class="panel panel--soft">
        <div class="panel-head">
            <div>
                <span class="section-tag">Estado rapido</span>
                <h3>Salud operativa del sistema</h3>
            </div>
        </div>
...
<section class="content-grid content-grid--3">
    <article class="panel" id="agenda">
        <div class="panel-head">
            <div>
                <span class="section-tag">Agenda visual</span>
    ...
    <article class="panel panel--map" id="mapa">
        <div class="panel-head">
            <div>
                ...
                <h3>Vista rapida de localizacion</h3>
            </div>
        </div>
        <div class="map-stage">
        ...
        <div class="map-legend">
            <?php foreach ($map_points as $point): ?>
                <div class="map-legend-item">
                    <span class="badge badge--<?php echo h($point['kind'] === 'evento' ? 'soft' : 'accent'); ?>"><?php echo h(ucfirst($point['kind'])); ?></span>
                    <div>
    ...
    <article class="stack-panel">
        <article class="panel panel--soft">
            <div class="panel-head">
                <div>
                    <span class="section-tag">Accesos rapidos</span>
                    <h3>Acciones listas</h3>
                </div>
            </div>
